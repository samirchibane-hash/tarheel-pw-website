      ...
      <div className="grid-2col" style={{ gap: 40, alignItems: "start" }}>
        ...
        <div className="sticky-sidebar" style={{ top: 110, alignSelf: "start" }}>
          ...
          <p style={{ fontSize: 16, color: "var(--ink-2)", maxWidth: 480, lineHeight: 1.5, marginBottom: 22 }}>
            A certified Tarheel tech will come to your home, test for numerous contaminants on-site,
...
const WhatToExpect = () => {
  const steps = [
    ...
    },
    {
      n: "02", icon: "beaker",
      t: "In-home testing",
      d: "Your tech tests your water on-site for numerous parameters — hardness, pH, chlorine, TDS, iron, bacteria indicators, and more.",
    },
    {
      n: "03", icon: "check",
